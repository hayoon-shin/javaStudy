package com.kh.studentScoreManagement.view;

public class MenuViewer {
	// 메인메뉴
		public static void mainMenuView() {
			System.out.println();
			System.out.println("미래대학교 학사관리 프로그램");
			System.out.println("해당 번호를 입력하세요.");
			System.out.println("1. 학생 정보 들어가기");
			System.out.println("2. 과목 정보 들어가기");
			System.out.println("3. 수강 신청 들어가기");
