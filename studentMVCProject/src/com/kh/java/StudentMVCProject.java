		...
		public static void main(String[] args) throws SQLException {
			...
			while (!exitFlag) {
				...
				case StudentCURDMenu.INSERT: {
					StudentRegisterManager.studentInsertManager();
					break;
				}
				case StudentCURDMenu.UPDATE: {
					StudentRegisterManager.studentUpdateManager();
					break;
				}
				case StudentCURDMenu.DELETE: {
					StudentRegisterManager.studentDeleteManager();;
					break;
				}
				case StudentCURDMenu.SORT: {
					StudentRegisterManager.studentSortManager();
					break;
				}
